<?php
    ...
    $d_amt = mysqli_real_escape_string($conn, $_POST["d_amt"]);
    ...
    $err_no = 0;
            ...
            $final_bal = $bal + $d_amt;
				...
				$sql2 = "INSERT INTO depositon (card_no, d_amt) VALUES ('$card_no', $d_amt)";
...
<div class="sidenav">
  ...
  <a href="deposition.php" class="active" class="hover"  style="border: 5px solid black;">Deposition</a>
...
<p class="heading">Welcome, &nbsp<?php echo $row02["c_name"]?>!</p>
    <div class="main">
        ...
        <div class="flex-item" >
            <a href="./deposition.php" class="button" style="font-size: 10x; padding: 10px; width: 70px;">Go Back</a>
        </div>
    </div>
