...
<div class="main">
	<form action="deposition_action.php" method="POST">
	<br>
	<br>
	<br>
	<label for="d_amt">Please enter the amount to be deposited.</label>
	<br>
    	<input type="number" min="0" id="d_amt" name="d_amt" placeholder="Enter amount">
	<br>
